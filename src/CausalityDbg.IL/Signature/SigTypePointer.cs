...
{
	public sealed partial class SigTypePointer : SigType
	{
		public SigTypePointer(SigType baseType, ImmutableArray<SigCustomModifier> customModifiers)
			: base(CorElementType.ELEMENT_TYPE_PTR)
		{
			BaseType = baseType;
